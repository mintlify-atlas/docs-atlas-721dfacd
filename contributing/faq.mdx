...
sidebarTitle: "FAQ"
description: "Answers to the most common questions about using, sharing, self-hosting, and contributing to the Stranger Things Intro Creator open-source tool."
---
...
<AccordionGroup>
  ...
  <Accordion title="What do I need to run this locally?">
    You need **Node.js v14 or higher** and **npm** (or **yarn**) installed on your machine. Once those are in place, clone the repository and run `npm install` to install dependencies. From there, follow the local development instructions in the repository README to start a preview in your browser. The project is frontend-only — there is no database or backend service to configure.
  </Accordion>
