...
<Steps>
  <Step title="Create your intro">
    Go to [strangerthingsintrocreator.com](https://strangerthingsintrocreator.com/), type your text into the input field, and click **Create** or **Generate** to play the animation. For a detailed walkthrough, see [Creating Your First Stranger Things Intro](/guides/creating-your-intro).
  </Step>
...
- **Blog posts and websites** — Embed the link as a standard HTML anchor tag (`<a href="...">`) or as a Markdown link. Readers can click through to watch the animation without leaving your site.
